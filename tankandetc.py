...
while running:
    ...
    # Draw the players and the enemies on the screen
    draw_player1(player1_x, player1_y)
    draw_player2(player2_x, player2_y)
    draw_bullet(bullet_x, bullet_y)
    draw_tank(tank_x, tank_y)
    draw_war_ship(war_ship_x, war_ship_y)
    draw_war_plane(war_plane_x, war_plane_y)
